...
export default class extends Controller {
  ...
  async updateField(event, endpoint, additionalParams = {}) {
    if (!event || !event.target) {
      console.error("Evento no válido o no definido.");
      return;
    }
    ...
    if (!fieldName) {
      console.error("El campo 'fieldName' no está definido en el dataset del elemento.");
      return;
    }
  
    console.log(`Procesando el cambio del campo: ${fieldName}`);
