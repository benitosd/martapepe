...
export default class extends Controller {
  ...
  resetToPrompt(excludeTarget) {
    // Recorre todos los targets y reinicia el valor excepto el excluido
  ...
  resetFields() {
    // Resetea todos los campos excepto itemType
    [this.materialTarget, this.thicknessTarget, this.colourTarget, this.providerTarget, this.sizeTarget].forEach(target => {
      target.innerHTML = '<option value="">Seleccione una opción</option>';
    });

    // Resetea los valores de los campos real_code y real_description
